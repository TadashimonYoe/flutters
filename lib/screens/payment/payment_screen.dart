        ...
        body: Obx(() {
          return AnimatedScrollView(
            ...
            children: [
              ...
              16.height,
              Obx(() {
                if (paymentCont.paymentOption.value == PaymentMethods.PAYMENT_METHOD_TADASHI) {
                  final String guideText = paymentCont.selectPayment.value.testValue?.stripeUrl.validate() ?? '';
                  return Column(
                    crossAxisAlignment: CrossAxisAlignment.stretch,
                    children: [
                      AppTextField(
                        controller: paymentCont.tadashiName,
                        textFieldType: TextFieldType.NAME,
                        decoration: inputDecorationWithFillBorder(context, labelText: 'Nombre'),
                      ),
                      12.height,
                      AppTextField(
                        controller: paymentCont.tadashiDesc,
                        textFieldType: TextFieldType.MULTILINE,
                        minLines: 1,
                        maxLines: 3,
                        decoration: inputDecorationWithFillBorder(context, labelText: 'Descripción'),
                      ),
                      12.height,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              8.height,
                              Text(guideText, style: secondaryTextStyle(color: white)),
                            ],
                          ),
                        ),
                      12.height,
                      Row(
                        children: [
                          Expanded(
                            child: AppButton(
                              text: 'Elegir archivo',
                              onTap: () => paymentCont.pickTadashiProof(),
                            ),
                          ),
                          12.width,
                          Obx(
                            () => Expanded(
                              child: Text(
                                paymentCont.tadashiProofFile.value != null
                                    ? paymentCont.tadashiProofFile.value!.path.split('/').last
                                    : 'Sin archivo',

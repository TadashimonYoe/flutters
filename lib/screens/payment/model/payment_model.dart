...
class PaymentSetting {
  ...
  PaymentSetting.fromJson(Map<String, dynamic> json)
      : id = json["id"],
        ...
        status = json["status"],
        isTest = json["is_test"],
        testValue = (json['value'] is Map<String, dynamic>) ? LiveValue.fromJson(json['value']) : LiveValue(),
        liveValue = (json['live_value'] is Map<String, dynamic>) ? LiveValue.fromJson(json['live_value']) : LiveValue();

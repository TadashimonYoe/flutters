    ...
    return Theme(
      ...
      child: ClipRRect(
        ...
        child: Obx(
          () => Directionality(
            textDirection: isRTL.value ? TextDirection.rtl : TextDirection.ltr,
            child: controller.isBuffering.isTrue && controller.mkVideoController == null
                ? LoaderWidget(loaderColor: appColorPrimary.withValues(alpha: 0.4))
                : Video(
                    controller: controller.mkVideoController!,
                    controls: yMaterialVideoControls,
                  ),
          ),
        ),
      ),

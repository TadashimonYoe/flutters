...
(double pendingPercentage, String timeLeft) calculatePendingPercentage(
  ...
  final double pendingPercentage =
      (pendingSeconds / totalSeconds).clamp(0.0, 1.0);
...
String formatMobileNumber(String mobileNumber) {
  ...
  final String formattedNumber =
      "+$countryCode $firstPart$maskedMiddlePart$lastPart";
...
void shareVideo({required String type, required int videoId}) {
  ...
  final Offset bottomPosition = Offset(screenWidth / 2,
      screenHeight - 100); // Centered horizontally, 100px from the bottom
